...
define([
    ...
    "ct/_Connect"
], function (declare, d_array, d_lang, d_locale, TimeSlider, geometry, ServiceTypes, _Connect) {
    return declare([_Connect], {
        activateTool: function (params) {
            var properties = params.tool._properties;
            ...
            try {
                ...
                var window = this.window = this._windowManager.createWindow({
        ...
        deactivateTool: function (params) {
